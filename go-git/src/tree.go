...
//}
//
//func HashObject(treeHash, fileName, hashValue string, oType ObjectType) error {
//	var t *TreeNode
//	var file *os.File
//	var err error
//	if treeHash != "" {
//		t, err = ReadTree(ConstantObjectsPath, treeHash)
//	} else {
//		t, err = ReadTree(ConstantConfigPath, TempTreeFile)
//	}
//	if err != nil {
//		return err
//	}
...
//	}
//	if treeHash != "" {
//		file, err = openFile(ConstantObjectsPath, treeHash, os.O_TRUNC|os.O_RDWR|os.O_CREATE)
//	} else {
//		file, err = openFile(ConstantConfigPath, TempTreeFile, os.O_TRUNC|os.O_RDWR|os.O_CREATE)
//	}
//
//	if err != nil {
//		return err
...
//	var err error
//	if treeHash != "" {
//		tree, err = ReadTree(ConstantObjectsPath, treeHash)
//	} else {
//		tree, err = ReadTree(ConstantConfigPath, TempTreeFile)
//	}
//	if err != nil {
//		return "", err
//	}
